...
func (_mock *MockValidator) Validate(s interface{}) error {
	ret := _mock.Called(s)
...
func (_c *MockValidator_Validate_Call) RunAndReturn(run func(s interface{}) error) *MockValidator_Validate_Call {
	_c.Call.Return(run)
	return _c
}
